...
("1_1_3_8_1",
:((~x)^(~!m)*((~e) + (~!f)*(~x)^(~!q) + (~!g)*(~x)^(~!r) + (~!h)*(~x)^(~!n))/((~a) + (~!c)*(~x)^(~!n))^(3//2)) => :(
...
("1_1_3_8_2",
:(((~d)*(~x))^ (~!m)*((~e) + (~!f)*(~x)^(~!q) + (~!g)*(~x)^(~!r) + (~!h)*(~x)^(~!n))/((~a) + (~!c)*(~x)^(~!n))^(3//2)) => :(
...
("1_1_3_8_31",
:(((~!c)*(~x))^(~!m)*(~Pq)*((~a1) + (~!b1)*(~x)^(~!n))^(~!p)*((~a2) + (~!b2)*(~x)^(~!n))^(~!p)) => :(
...
("1_1_3_8_33",
:(((~!h)*(~x))^(~!m)*((~e) + (~!f)*(~x)^(~!n) + (~!g)*(~x)^(~!n2))*((~a) + (~!b)*(~x)^(~!n))^ (~!p)*((~c) + (~!d)*(~x)^(~!n))^(~!p)) => :(
...
("1_1_3_8_34",
:(((~!h)*(~x))^(~!m)*((~e) + (~!g)*(~x)^(~!n2))*((~a) + (~!b)*(~x)^(~!n))^ (~!p)*((~c) + (~!d)*(~x)^(~!n))^(~!p)) => :(
