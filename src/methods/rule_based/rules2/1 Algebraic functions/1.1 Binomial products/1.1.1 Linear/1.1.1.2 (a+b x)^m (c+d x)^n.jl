...
("1_1_1_2_5",
:(((~a) + (~!b)*(~x))^(~m::P_igt_x_plus_half)*((~c) + (~!d)*(~x))^(~m::P_igt_x_plus_half)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) ?
(~x)*((~a) + (~b)*(~x))^(~m)*((~c) + (~d)*(~x))^(~m)⨸(2*(~m) + 1) + 2*(~a)*(~c)*(~m)⨸(2*(~m) + 1)*∫(((~a) + (~b)*(~x))^((~m) - 1)*((~c) + (~d)*(~x))^((~m) - 1), (~x)) : nothing))

("1_1_1_2_6",
:(1/(((~a) + (~!b)*(~x))^(3//2)*((~c) + (~!d)*(~x))^(3//2))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) ?
(~x)⨸((~a)*(~c)*sqrt((~a) + (~b)*(~x))*sqrt((~c) + (~d)*(~x))) : nothing))

("1_1_1_2_7",
:(((~a) + (~!b)*(~x))^(~m::P_ilt_x_plus_3half)*((~c) + (~!d)*(~x))^(~m::P_ilt_x_plus_3half)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) ?
...
("1_1_1_2_10",
:(((~!a) + (~!b)*(~x))^(~m::P_ilt_x_neg1)*((~!c) + (~!d)*(~x))^(~n::P_gt_0)) => :(
...
("1_1_1_2_11",
:(((~!a) + (~!b)*(~x))^(~m::P_ilt_x_neg1)*((~!c) + (~!d)*(~x))^(~n::P_lt_x_0)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~n), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !(ext_isinteger((~n))) ?
...
("1_1_1_2_18",
:(((~a) + (~!b)*(~x))^(~m::P_igt_x_plus_half)*((~c) + (~!d)*(~x))^(~n::P_igt_x_plus_half)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    lt((~m), (~n)) ?
...
("1_1_1_2_21",
:(1/(sqrt((~a::P_gt_0) + (~!b)*(~x))*sqrt((~c) + (~!d)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~a) + (~c), 0) &&
    eq((~b) - (~d), 0) ?
...
("1_1_1_2_23",
:(1/(sqrt((~!a) + (~!b::P_gt_0)*(~x))*sqrt((~!c) + (~!d)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    gt((~b)*(~c) - (~a)*(~d), 0) ?
...
("1_1_1_2_32",
:(((~!a) + (~!b)*(~x))^(~m::P_lt_neg1_x_0)*((~!c) + (~!d)*(~x))^(~n::P_le_neg1_x_0)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
...
("1_1_1_2_37",
:(((~a) + (~!b)*(~x))^(~m::(!ext_isinteger))*((~c) + (~!d)*(~x))^(~n::ext_isinteger)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~m), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) ?
