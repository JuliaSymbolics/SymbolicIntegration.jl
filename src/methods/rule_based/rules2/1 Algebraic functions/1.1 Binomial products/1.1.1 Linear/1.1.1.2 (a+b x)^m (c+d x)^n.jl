...
("1_1_1_2_5",
:(∫(((~a) + (~!b)*(~x))^(~m::(m->igt(m + 1/2, 0)))*((~c) + (~!d)*(~x))^(~m::(m->igt(m + 1/2, 0))),(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) ?
...
("1_1_1_2_21",
:(∫(1/(sqrt((~a::(a->gt(a, 0))) + (~!b)*(~x))*sqrt((~c) + (~!d)*(~x))),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~a) + (~c), 0) &&
    eq((~b) - (~d), 0) ?
...
("1_1_1_2_23",
:(∫(1/(sqrt((~!a) + (~!b::(b->gt(b, 0)))*(~x))*sqrt((~!c) + (~!d)*(~x))),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    gt((~b)*(~c) - (~a)*(~d), 0) ?
