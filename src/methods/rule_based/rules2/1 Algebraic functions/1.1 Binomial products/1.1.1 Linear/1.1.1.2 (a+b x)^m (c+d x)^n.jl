...
("1_1_1_2_5",
:(∫(((~a) + (~!b)*(~x))^(~m::pred_igt_m_plus_half)*((~c) + (~!d)*(~x))^(~m::pred_igt_m_plus_half),(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) ?
...
("1_1_1_2_20",
:(∫(((~!a) + (~!b)*(~x))^(~m::pred_lt_m_neg1)*((~!c) + (~!d)*(~x))^(~n),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~n), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !(
        lt((~n), -1) &&
...
("1_1_1_2_21",
:(∫(1/(sqrt((~a::pred_gt_a_0) + (~!b)*(~x))*sqrt((~c) + (~!d)*(~x))),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~a) + (~c), 0) &&
    eq((~b) - (~d), 0) ?
...
("1_1_1_2_23",
:(∫(1/(sqrt((~!a) + (~!b::pred_gt_b_0)*(~x))*sqrt((~!c) + (~!d)*(~x))),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    gt((~b)*(~c) - (~a)*(~d), 0) ?
...
("1_1_1_2_32",
:(∫(((~!a) + (~!b)*(~x))^(~m::pred_lt_neg1_m_0)*((~!c) + (~!d)*(~x))^(~n::pred_le_neg1_n_0),(~x)) ) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
