...
("7_1_5_9",
:(((~!f) + (~!g)*(~x) + (~!h)*(~x)^2)^ (~!p)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~n)/((~d) + (~!e)*(~x))^2) => :(
...
("7_1_5_11",
:(((~f) + (~!g)*(~x))^(~!m)*((~d) + (~!e)*(~x)^2)^(~p)*((~!a) + (~!b)*asinh((~!c)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~m), 0) &&
    ilt((~p) + 1/2, 0) &&
...
("7_1_5_12",
:(((~f) + (~!g)*(~x))^(~!m)*((~d) + (~!e)*(~x)^2)^(~p)*((~!a) + (~!b)*asinh((~!c)*(~x)))^ (~!n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~m), 0) &&
    ext_isinteger((~p) + 1/2) &&
...
("7_1_5_13",
:(((~!f) + (~!g)*(~x))^(~m)* sqrt((~d) + (~!e)*(~x)^2)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    ilt((~m), 0) &&
    gt((~d), 0) &&
...
("7_1_5_16",
:(((~f) + (~!g)*(~x))^(~!m)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~n)/ sqrt((~d) + (~!e)*(~x)^2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~m), 0) &&
    gt((~d), 0) &&
...
("7_1_5_20",
:(log((~!h)*((~!f) + (~!g)*(~x))^(~!m))*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)/ sqrt((~d) + (~!e)*(~x)^2)) => :(
...
("7_1_5_21",
:(log((~!h)*((~!f) + (~!g)*(~x))^(~!m))*((~d) + (~!e)*(~x)^2)^ (~p)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)) => :(
...
("7_1_5_26",
:((~!Px)*((~f) + (~!g)*((~d) + (~!e)*(~x)^2)^(~p))^ (~!m)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    poly((~Px), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~p) + 1/2, 0) &&
