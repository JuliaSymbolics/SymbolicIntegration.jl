...
("3_5_19",
:(((~!g)*(~x))^(~!m)*log((~!d) + (~!e)*(~x) + (~!f)*sqrt((~!a) + (~!c)*(~x)^2))) => :(
...
("3_5_23",
:(((~!d)*(~x)^(~!m) + (~!e)*log((~!c)*(~x)^(~!n))^(~!r))/((~x)*((~!a)*(~x)^(~!m) + (~!b)*log((~!c)*(~x)^(~!n))^(~q)))) => :(
...
("3_5_24",
:(((~u) + (~!d)*(~x)^(~!m) + (~!e)*log((~!c)*(~x)^(~!n))^(~!r))/((~x)*((~!a)*(~x)^(~!m) + (~!b)*log((~!c)*(~x)^(~!n))^(~q)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~q), (~r), (~x)) &&
    eq((~r), (~q) - 1) &&
    eq((~a)*(~e)*(~m) - (~b)*(~d)*(~n)*(~q), 0) ?
...
("3_5_26",
:(((~!d)*(~x)^(~!m) + (~!e)*log((~!c)*(~x)^(~!n))^(~!r))*((~!a)*(~x)^(~!m) + (~!b)*log((~!c)*(~x)^(~!n))^(~q))^ (~!p)/(~x)) => :(
...
("3_5_28",
:(((~!d)*(~x)^(~!m) + (~!e)*(~x)^(~!m)*log((~!c)*(~x)^(~!n)) + (~!f)*log((~!c)*(~x)^(~!n))^ (~!q))/((~x)*((~!a)*(~x)^(~!m) + (~!b)*log((~!c)*(~x)^(~!n))^(~q))^2)) => :(
...
("3_5_29",
:(((~d) + (~!e)*log((~!c)*(~x)^(~!n)))/((~!a)*(~x) + (~!b)*log((~!c)*(~x)^(~!n))^(~q))^2) => :(
