...
("3_4_20",
:((~x)^(~!m)*((~!f) + (~!g)*(~x))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x)^(~n))^(~!p)))^(~!q)) => :(
...
("3_4_21",
:(((~!h)*(~x))^(~m)*((~!f) + (~!g)*(~x))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x)^(~!n))^(~!p)))^(~!q)) => :(
...
("3_4_29",
:((~x)^(~!m)*((~f) + (~!g)*(~x)^(~s))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x)^(~n))^(~!p)))^(~!q)) => :(
...
("3_4_33",
:(((~!h)*(~x))^(~m)*((~!f) + (~!g)*(~x)^(~!s))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x)^(~!n))^(~!p)))^(~!q)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~p), (~r), (~x)) &&
    isfraction((~m)) &&
    ext_isinteger((~n)) &&
    ext_isinteger((~s)) ?
