...
("3_1_5_6",
:(((~!f)*(~x))^(~!m)*((~d) + (~!e)*(~x)^(~r))^(~!q)*((~!a) + (~!b)*log((~!c)*(~x)^(~n)))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~q), (~r), (~x)) &&
    eq((~m), (~r) - 1) &&
    igt((~p), 0) &&
    (
...
("3_1_5_13",
:((~x)^(~!m)*((~d1) + (~!e1)*(~x))^(~q)*((~d2) + (~!e2)*(~x))^ (~q)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))) => :(
...
("3_1_5_31",
:(((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)*((~d) + (~!e)*log((~!c)*(~x)^(~!n)))^(~!q)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~n), (~x)) &&
    ext_isinteger((~p)) &&
    ext_isinteger((~q)) ?
...
("3_1_5_33",
:(((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)*((~!d) + (~!e)*log((~!f)*(~x)^(~!r)))^(~!q)) => :(
...
("3_1_5_37",
:(((~!g)*(~x))^(~!m)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^ (~!p)*((~!d) + (~!e)*log((~!f)*(~x)^(~!r)))) => :(
...
("3_1_5_38",
:(((~!g)*(~x))^(~!m)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^ (~!p)*((~!d) + (~!e)*log((~!f)*(~x)^(~!r)))^(~!q)) => :(
...
("3_1_5_41",
:(log((~!d)*((~e) + (~!f)*(~x)^(~!m))^(~!r))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)) => :(
...
("3_1_5_45",
:(log((~!d)*((~e) + (~!f)*(~x)^(~!m)))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)/(~x)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~x)) &&
    igt((~p), 0) &&
    eq((~d)*(~e), 1) ?
...
("3_1_5_47",
:(((~!g)*(~x))^(~!q)* log((~!d)*((~e) + (~!f)*(~x)^(~!m))^(~!r))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))) => :(
...
("3_1_5_48",
:(((~!g)*(~x))^(~!q)* log((~!d)*((~e) + (~!f)*(~x)^(~!m)))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)) => :(
...
("3_1_5_49",
:(((~!g)*(~x))^(~!q)* log((~!d)*((~e) + (~!f)*(~x)^(~!m))^(~!r))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~r), (~m), (~n), (~q), (~x)) &&
    igt((~p), 0) &&
    isrational((~m)) &&
    isrational((~q)) ?
...
("3_1_5_51",
:(((~!g)*(~x))^(~!q)*log((~!d)*(~u)^(~!r))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)) => :(
...
("3_1_5_52",
:(PolyLog.reli((~k), (~!e)*(~x)^(~!q))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))) => :(
...
("3_1_5_54",
:(PolyLog.reli((~k), (~!e)*(~x)^(~!q))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)/(~x)) => :(
...
("3_1_5_56",
:(((~!d)*(~x))^(~!m)*PolyLog.reli((~k), (~!e)*(~x)^(~!q))*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))) => :(
