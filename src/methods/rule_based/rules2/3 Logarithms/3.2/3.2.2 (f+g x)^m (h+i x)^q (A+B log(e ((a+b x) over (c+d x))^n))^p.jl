...
("3_2_2_1",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!h) + (~!i)*(~x))*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))) => :(
...
("3_2_2_2",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!h) + (~!i)*(~x))*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~A), (~B), (~m), (~n), (~x)) &&
    eq((~n) + (~mn), 0) &&
    igt((~n), 0) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
...
("3_2_2_3",
:(((~!f) + (~!g)*(~x))^(~!m)*((~!h) + (~!i)*(~x))^ (~!q)*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))^(~!p)) => :(
...
("3_2_2_4",
:(((~!f) + (~!g)*(~x))^(~!m)*((~!h) + (~!i)*(~x))^ (~!q)*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~A), (~B), (~n), (~p), (~x)) &&
    eq((~n) + (~mn), 0) &&
    igt((~n), 0) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
...
("3_2_2_16",
:(((~!f) + (~!g)*(~x) + (~!h)*(~x)^2)^ (~!m)*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))^(~!p)) => :(
...
("3_2_2_17",
:(((~!f) + (~!g)*(~x) + (~!h)*(~x)^2)^ (~!m)*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~A), (~B), (~n), (~p), (~x)) &&
    eq((~n) + (~mn), 0) &&
    igt((~n), 0) &&
    eq((~b)*(~d)*(~f) - (~a)*(~c)*(~h), 0) &&
...
("3_2_2_18",
:((~Px)^(~!m)*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))^ (~!p)) => :(
...
("3_2_2_19",
:((~Px)^ (~!m)*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~n), (~x)) &&
    poly((~Px), (~x), 2) &&
    eq((~n) + (~mn), 0) &&
    igt((~n), 0) &&
