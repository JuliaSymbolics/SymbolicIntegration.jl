...
("3_2_1_8",
:(((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))/((~!f) + (~!g)*(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~A), (~B), (~n), (~x)) &&
    eq((~n) + (~mn), 0) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~b)*(~f) - (~a)*(~g), 0) ?
...
("3_2_1_13",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))) => :(
...
("3_2_1_14",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~A), (~B), (~m), (~n), (~x)) &&
    eq((~n) + (~mn), 0) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~m), -1) &&
...
("3_2_1_15",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!A) + (~!B)*log((~!e)*(((~!a) + (~!b)*(~x))/((~!c) + (~!d)*(~x)))^(~!n)))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~A), (~B), (~n), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    ext_isinteger((~m), (~p)) &&
    eq((~b)*(~f) - (~a)*(~g), 0) &&
...
("3_2_1_16",
:(((~!f) + (~!g)*(~x))^ (~!m)*((~!A) + (~!B)*log((~!e)*((~!a) + (~!b)*(~x))^(~!n)*((~!c) + (~!d)*(~x))^(~mn)))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~A), (~B), (~n), (~x)) &&
    eq((~n) + (~mn), 0) &&
    igt((~n), 0) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
