...
("3_2_3_3",
:(log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))/((~!g) + (~!h)*(~x))) => :(
...
("3_2_3_4",
:(((~!g) + (~!h)*(~x))^(~!m)* log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))) => :(
...
("3_2_3_5",
:(log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))^2/((~!g) + (~!h)*(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~p), (~q), (~r), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~b)*(~g) - (~a)*(~h), 0) ?
...
("3_2_3_7",
:(((~!g) + (~!h)*(~x))^(~!m)* log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))^(~s)) => :(
...
("3_2_3_8",
:(((~!s) + (~!t)*log((~!i)*((~!g) + (~!h)*(~x))^(~!n)))^(~!m)* log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))/((~!j) + (~!k)*(~x))) => :(
...
("3_2_3_9",
:(((~!s) + (~!t)*log((~!i)*((~!g) + (~!h)*(~x))^(~!n)))* log((~!e)*((~!f)*((~!a) + (~!b)*(~x))^(~!p)*((~!c) + (~!d)*(~x))^(~!q))^(~!r))/((~!j) + (~!k)*(~x))) => :(
...
("3_2_3_14",
:(((~!a) + (~!b)*log((~!c)*sqrt((~!d) + (~!e)*(~x))/sqrt((~!f) + (~!g)*(~x))))^ (~!n)/((~!A) + (~!B)*(~x) + (~!C)*(~x)^2)) => :(
...
("3_2_3_15",
:(((~!a) + (~!b)*log((~!c)*sqrt((~!d) + (~!e)*(~x))/sqrt((~!f) + (~!g)*(~x))))^ (~!n)/((~!A) + (~!C)*(~x)^2)) => :(
