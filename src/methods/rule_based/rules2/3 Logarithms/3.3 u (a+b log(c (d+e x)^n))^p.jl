...
("3_3_16",
:(((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))/sqrt((~f) + (~!g)*(~x)^2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~n), (~x)) &&
    gt((~f), 0) ?
let
    u = ∫(1⨸sqrt((~f) + (~g)*(~x)^2), (~x))
...
("3_3_17",
:(((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))/(sqrt((~f1) + (~!g1)*(~x))* sqrt((~f2) + (~!g2)*(~x)))) => :(
...
("3_3_23",
:(((~!f) + (~!g)*(~x))^(~!q)*((~!h) + (~!i)*(~x))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^(~!p)) => :(
...
("3_3_24",
:((~x)^(~!m)*((~f) + (~g)/(~x))^(~!q)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^ (~!p)) => :(
...
("3_3_25",
:((~x)^(~!m)*((~!f) + (~!g)*(~x)^(~!r))^ (~!q)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^(~!p)) => :(
...
("3_3_26",
:((~x)^(~!m)*((~f) + (~!g)*(~x)^(~!r))^ (~!q)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~m), (~n), (~q), (~r), (~x)) &&
    ext_isinteger((~m)) &&
    ext_isinteger((~q)) &&
    ext_isinteger((~r)) ?
...
("3_3_28",
:(((~!h)*(~x))^(~!m)*((~f) + (~!g)*(~x)^(~!r))^ (~!q)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^(~!p)) => :(
...
("3_3_38",
:(((~!g)*(~x))^(~!q)* log((~!f)*(~x)^(~!m))*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))) => :(
...
("3_3_40",
:(((~!g)*(~x))^(~!q)* log((~!f)*(~x)^(~!m))*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^(~p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~m), (~n), (~q), (~x)) &&
    igt((~p), 1) &&
    igt((~q), 0) ?
let
...
("3_3_46",
:(((~!k) + (~!l)*(~x))^(~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^ (~!p)*((~!f) + (~!g)*log((~!h)*((~!i) + (~!j)*(~x))^(~!m)))) => :(
...
("3_3_48",
:((~x)^(~!m)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))*((~!f) + (~!g)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))) => :(
...
("3_3_49",
:(((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))*((~!f) + (~!g)*log((~!h)*((~!i) + (~!j)*(~x))^(~!m)))/(~x)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~j), (~m), (~n), (~x)) &&
    eq((~e)*(~i) - (~d)*(~j), 0) ?
...
("3_3_54",
:((~x)^(~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^ (~!p)*((~!f) + (~!g)*log((~!h)*((~!i) + (~!j)*(~x))^(~!m)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~j), (~m), (~n), (~x)) &&
    igt((~p), 0) &&
    ext_isinteger((~r)) &&
    (
...
("3_3_55",
:(((~k) + (~!l)*(~x))^ (~!r)*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))*((~!f) + (~!g)*log((~!h)*((~!i) + (~!j)*(~x))^(~!m)))) => :(
...
("3_3_57",
:(PolyLog.reli((~k), (~h) + (~!i)*(~x))*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))^ (~!p)/((~f) + (~!g)*(~x))) => :(
...
("3_3_58",
:((~!Px)* (~F)((~!f)*((~!g) + (~!h)*(~x)))*((~!a) + (~!b)*log((~!c)*((~d) + (~!e)*(~x))^(~!n)))) => :(
