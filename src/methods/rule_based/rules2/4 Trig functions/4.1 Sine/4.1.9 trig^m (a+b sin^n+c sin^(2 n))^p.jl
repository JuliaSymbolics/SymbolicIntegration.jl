...
("4_1_9_1",
:(((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
...
("4_1_9_2",
:(((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
    ext_isinteger((~p)) ?
...
("4_1_9_5",
:(1/((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !eq((~b)^2 - 4*(~a)*(~c), 0) ?
...
("4_1_9_6",
:(1/((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !eq((~b)^2 - 4*(~a)*(~c), 0) ?
...
("4_1_9_7",
:(sin((~!d) + (~!e)*(~x))^ (~!m)*((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))^(~p)) => :(
...
("4_1_9_8",
:(cos((~!d) + (~!e)*(~x))^ (~!m)*((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))^(~p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
    ext_isinteger((~p)) ?
...
("4_1_9_17",
:(cos((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_18",
:(sin((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_27",
:(tan((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_28",
:(cot((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_37",
:(cot((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*sin((~!d) + (~!e)*(~x))^(~!n) + (~!c)*sin((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_38",
:(tan((~!d) + (~!e)*(~x))^ (~m)*((~!a) + (~!b)*cos((~!d) + (~!e)*(~x))^(~!n) + (~!c)*cos((~!d) + (~!e)*(~x))^(~!n2))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~m), (~n), (~x)) &&
    eq((~n2), 2*(~n)) &&
    !(ext_isinteger(((~m) - 1)/2)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
...
("4_1_9_45",
:(((~A) + (~!B)*sin((~!d) + (~!e)*(~x)))*((~a) + (~!b)*sin((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x))^2)^(~n)) => :(
...
("4_1_9_46",
:(((~A) + (~!B)*cos((~!d) + (~!e)*(~x)))*((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*cos((~!d) + (~!e)*(~x))^2)^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~x)) &&
    eq((~b)^2 - 4*(~a)*(~c), 0) &&
    ext_isinteger((~n)) ?
...
("4_1_9_49",
:(((~A) + (~!B)*sin((~!d) + (~!e)*(~x)))/((~!a) + (~!b)*sin((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x))^2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~x)) &&
    !eq((~b)^2 - 4*(~a)*(~c), 0) ?
...
("4_1_9_50",
:(((~A) + (~!B)*cos((~!d) + (~!e)*(~x)))/((~!a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*cos((~!d) + (~!e)*(~x))^2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~x)) &&
    !eq((~b)^2 - 4*(~a)*(~c), 0) ?
