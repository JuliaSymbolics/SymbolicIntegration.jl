...
("4_1_6_3",
:(1/((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~a)^2 - (~b)^2 - (~c)^2, 0) ?
-((~c) - (~a)*sin((~d) + (~e)*(~x)))⨸((~c)*(~e)*((~c)*cos((~d) + (~e)*(~x)) - (~b)*sin((~d) + (~e)*(~x)))) : nothing))

("4_1_6_4",
:(1/sqrt((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~a)^2 - (~b)^2 - (~c)^2, 0) ?
...
("4_1_6_17",
:(1/((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^(3//2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    !eq((~a)^2 - (~b)^2 - (~c)^2, 0) ?
...
("4_1_6_19",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)) + (~!C)*sin((~!d) + (~!e)*(~x)))/((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
...
("4_1_6_20",
:(((~!A) + (~!C)*sin((~!d) + (~!e)*(~x)))/((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
...
("4_1_6_21",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)))/((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
...
("4_1_6_28",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)) + (~!C)*sin((~!d) + (~!e)*(~x)))*((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^(~!n)) => :(
...
("4_1_6_29",
:(((~!A) + (~!C)*sin((~!d) + (~!e)*(~x)))*((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^(~!n)) => :(
...
("4_1_6_30",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)))*((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^(~!n)) => :(
...
("4_1_6_34",
:(((~!B)*cos((~!d) + (~!e)*(~x)) + (~!C)*sin((~!d) + (~!e)*(~x)))*((~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^(~!n)) => :(
...
("4_1_6_38",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)) + (~!C)*sin((~!d) + (~!e)*(~x)))/ sqrt((~a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~C), (~x)) &&
    eq((~B)*(~c) - (~b)*(~C), 0) &&
    !eq((~A)*(~b) - (~a)*(~B), 0) ?
...
("4_1_6_39",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)) + (~!C)*sin((~!d) + (~!e)*(~x)))/((~!a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^2) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~C), (~x)) &&
    !eq((~a)^2 - (~b)^2 - (~c)^2, 0) &&
    eq((~a)*(~A) - (~b)*(~B) - (~c)*(~C), 0) ?
...
("4_1_6_40",
:(((~!A) + (~!C)*sin((~!d) + (~!e)*(~x)))/((~!a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^2) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~C), (~x)) &&
    !eq((~a)^2 - (~b)^2 - (~c)^2, 0) &&
    eq((~a)*(~A) - (~c)*(~C), 0) ?
...
("4_1_6_41",
:(((~!A) + (~!B)*cos((~!d) + (~!e)*(~x)))/((~!a) + (~!b)*cos((~!d) + (~!e)*(~x)) + (~!c)*sin((~!d) + (~!e)*(~x)))^2) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~A), (~B), (~x)) &&
    !eq((~a)^2 - (~b)^2 - (~c)^2, 0) &&
    eq((~a)*(~A) - (~b)*(~B), 0) ?
...
("4_1_6_48",
:(1/((~!a) + (~!b)*sec((~!d) + (~!e)*(~x)) + (~!c)*tan((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) ?
∫(cos((~d) + (~e)*(~x))⨸((~b) + (~a)*cos((~d) + (~e)*(~x)) + (~c)*sin((~d) + (~e)*(~x))), (~x)) : nothing))

("4_1_6_49",
:(1/((~!a) + (~!b)*csc((~!d) + (~!e)*(~x)) + (~!c)*cot((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) ?
∫(sin((~d) + (~e)*(~x))⨸((~b) + (~a)*sin((~d) + (~e)*(~x)) + (~c)*cos((~d) + (~e)*(~x))), (~x)) : nothing))

("4_1_6_50",
:(cos((~!d) + (~!e)*(~x))^ (~!n)*((~!a) + (~!b)*sec((~!d) + (~!e)*(~x)) + (~!c)*tan((~!d) + (~!e)*(~x)))^(~!n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    ext_isinteger((~n)) ?
∫(((~b) + (~a)*cos((~d) + (~e)*(~x)) + (~c)*sin((~d) + (~e)*(~x)))^(~n), (~x)) : nothing))

("4_1_6_51",
:(sin((~!d) + (~!e)*(~x))^ (~!n)*((~!a) + (~!b)*csc((~!d) + (~!e)*(~x)) + (~!c)*cot((~!d) + (~!e)*(~x)))^(~!n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    ext_isinteger((~n)) ?
...
("4_1_6_54",
:(sec((~!d) + (~!e)*(~x))^ (~!n)*((~!a) + (~!b)*sec((~!d) + (~!e)*(~x)) + (~!c)*tan((~!d) + (~!e)*(~x)))^(~m)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~m) + (~n), 0) &&
    ext_isinteger((~n)) ?
...
("4_1_6_55",
:(csc((~!d) + (~!e)*(~x))^ (~!n)*((~!a) + (~!b)*csc((~!d) + (~!e)*(~x)) + (~!c)*cot((~!d) + (~!e)*(~x)))^(~m)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~m) + (~n), 0) &&
    ext_isinteger((~n)) ?
