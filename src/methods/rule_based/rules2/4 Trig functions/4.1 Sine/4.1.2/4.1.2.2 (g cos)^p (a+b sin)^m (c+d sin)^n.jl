...
("4_1_2_2_6",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~!n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_2_2_10",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^ (~p)/(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))* sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
...
("4_1_2_2_15",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~m)*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
...
("4_1_2_2_22",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~!m)*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~m), (~p), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) &&
...
("4_1_2_2_25",
:(cos((~!e) + (~!f)*(~x))^2*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~m)*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_2_2_35",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^ (~p)*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))/((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_2_37",
:(cos((~!e) + (~!f)*(~x))^(~p)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~m)*((~!d)*sin((~!e) + (~!f)*(~x)))^(~n)) => :(
...
("4_1_2_2_38",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)* sin((~!e) + (~!f)*(~x))^2*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
...
("4_1_2_2_40",
:(cos((~!e) + (~!f)*(~x))^(~p)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
...
("4_1_2_2_41",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~g), (~n), (~p), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) &&
    igt((~m), 0) ?
...
("4_1_2_2_42",
:(cos((~!e) + (~!f)*(~x))^2*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
...
("4_1_2_2_48",
:(cos((~!e) + (~!f)*(~x))^4*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~n), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) &&
    lt((~m), -1) ?
...
("4_1_2_2_55",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)/ sqrt((~!d)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_2_2_64",
:(cos((~!e) + (~!f)*(~x))^6*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~m), (~n), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    ext_isinteger(2*(~m), 2*(~n)) &&
    !eq((~n), -1) &&
...
("4_1_2_2_66",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)* sin((~!e) + (~!f)*(~x))^(~n)/((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~p), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    ext_isinteger((~n)) &&
    (
...
("4_1_2_2_76",
:(sqrt( (~!d)*sin((~!e) + (~!f)*(~x)))/(sqrt( (~!g)*cos((~!e) + (~!f)*(~x)))*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~g), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_2_79",
:(((~!g)*cos((~!e) + (~!f)*(~x)))^(~p)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^2) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~g), (~n), (~p), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_2_84",
:(cos((~!e) + (~!f)*(~x))^2*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~m)*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) &&
    ext_isinteger(2*(~m), 2*(~n)) ?
