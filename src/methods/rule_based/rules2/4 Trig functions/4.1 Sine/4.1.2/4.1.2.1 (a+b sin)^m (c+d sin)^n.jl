...
("4_1_2_1_4",
:(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))/sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_1_5",
:(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~n), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~n), -1/2) ?
...
("4_1_2_1_8",
:(1/(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))* sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_1_19",
:(((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))/sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_1_27",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~m)*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^2) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    lt((~m), -1) ?
...
("4_1_2_1_38",
:(sqrt( (~a) + (~!b)*sin((~!e) + (~!f)*(~x)))/((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))^(3//2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_41",
:(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))/sqrt((~!d)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_2_1_44",
:(sqrt((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))/ sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_45",
:(((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))^(~n)/sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) &&
...
("4_1_2_1_47",
:(1/(sqrt( (~a) + (~!b)*sin((~!e) + (~!f)*(~x)))*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_48",
:(1/(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))*sqrt((~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) &&
    eq((~d), (~a)/(~b)) &&
    gt((~a), 0) ?
...
("4_1_2_1_67",
:(1/(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)* sqrt((~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_1_68",
:(1/(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)* sqrt((~!c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_70",
:(sqrt((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))/((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_71",
:(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)/((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_2_1_72",
:(1/(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))* sqrt((~!c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) &&
...
("4_1_2_1_75",
:(sqrt((~!b)*sin((~!e) + (~!f)*(~x)))/sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_2_1_87",
:(((~!d)*sin((~!e) + (~!f)*(~x)))^(3//2)/sqrt((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_2_1_93",
:(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~!m)*((~!c)*((~!d)*sin((~!e) + (~!f)*(~x)))^(~p))^(~n)) => :(
...
("4_1_2_1_97",
:(((~a) + (~!b)*cos((~!e) + (~!f)*(~x)))^(~!m)*((~c) + (~!d)*sec((~!e) + (~!f)*(~x)))^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~n), (~x)) &&
    !(ext_isinteger((~n))) &&
    ext_isinteger((~m)) ?
