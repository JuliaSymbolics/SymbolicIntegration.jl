...
("4_1_7_1",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x))^2)) => :(
...
("4_1_7_2",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~p)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x))^2)) => :(
    !contains_var((~a), (~b), (~e), (~f), (~A), (~B), (~x)) &&
    gt((~p), 0) ?
...
("4_1_7_4",
:(((~!A) + (~!B)*sin((~!e) + (~!f)*(~x))^2)/ sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)) => :(
    !contains_var((~a), (~b), (~e), (~f), (~A), (~B), (~x)) ?
...
("4_1_7_21",
:(((~!d)*sin((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
...
("4_1_7_25",
:(((~!d)*cos((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~m), (~p), (~x)) &&
    !(ext_isinteger((~m))) ?
...
("4_1_7_27",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
...
("4_1_7_30",
:(cos((~!e) + (~!f)*(~x))^(~!m)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~!n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
...
("4_1_7_31",
:(((~!c)*sin((~!e) + (~!f)*(~x)))^(~m)* sin((~!e) + (~!f)*(~x))^(~!n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
...
("4_1_7_32",
:(cos((~!e) + (~!f)*(~x))^(~m)* sin((~!e) + (~!f)*(~x))^(~n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
    !contains_var((~a), (~b), (~e), (~f), (~x)) &&
    ext_isinteger((~m)/2) &&
    ext_isinteger((~n)/2) &&
    ext_isinteger((~p)) ?
...
("4_1_7_34",
:(((~!c)*cos((~!e) + (~!f)*(~x)))^(~m)*((~!d)*sin((~!e) + (~!f)*(~x)))^ (~!n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^2)^(~!p)) => :(
...
("4_1_7_53",
:(((~!d)*sin((~!e) + (~!f)*(~x)))^(~!m)*((~a) + (~!b)*((~!c)*sin((~!e) + (~!f)*(~x)))^(~n))^ (~!p)) => :(
...
("4_1_7_55",
:(cos((~!e) + (~!f)*(~x))^(~!m)*((~a) + (~!b)*((~!c)*sin((~!e) + (~!f)*(~x)))^(~n))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~e), (~f), (~n), (~p), (~x)) &&
    ext_isinteger(((~m) - 1)/2) &&
    (
        eq((~n), 4) ||
...
("4_1_7_59",
:(((~!d)*cos((~!e) + (~!f)*(~x)))^(~!m)*((~a) + (~!b)*((~!c)*sin((~!e) + (~!f)*(~x)))^(~n))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~x)) &&
    igt((~p), 0) ?
...
("4_1_7_62",
:(tan((~!e) + (~!f)*(~x))^(~!m)*((~a) + (~!b)*((~!c)*sin((~!e) + (~!f)*(~x)))^(~n))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~e), (~f), (~n), (~p), (~x)) &&
    ilt(((~m) - 1)/2, 0) ?
...
("4_1_7_63",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^4)^(~!p)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~m), (~x)) &&
    ext_isinteger((~p)) ?
...
("4_1_7_65",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))^(~n))^(~!p)) => :(
    !contains_var((~a), (~b), (~d), (~e), (~f), (~m), (~x)) &&
    ext_isinteger((~n)/2) &&
    igt((~p), 0) ?
...
("4_1_7_66",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~!m)*((~a) + (~!b)*((~!c)*sin((~!e) + (~!f)*(~x)))^(~n))^ (~!p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~x)) &&
    igt((~p), 0) ?
