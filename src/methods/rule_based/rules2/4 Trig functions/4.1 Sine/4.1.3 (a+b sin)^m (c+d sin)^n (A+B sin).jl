...
("4_1_3_1",
:(sin((~!e) + (~!f)*(~x))^(~!n)*((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~!m)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_3_2",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~!m)*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^ (~!n)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))) => :(
...
("4_1_3_6",
:(sqrt((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~n), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_3_20",
:(((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(sqrt( (~a) + (~!b)*sin((~!e) + (~!f)*(~x)))*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_3_21",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^ (~m)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~m), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) &&
...
("4_1_3_23",
:(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))^2*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))^ (~n)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) &&
...
("4_1_3_26",
:(sqrt( (~c) + (~!d)*sin((~!e) + (~!f)*(~x)))*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/((~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)) => :(
...
("4_1_3_27",
:(sqrt( (~!c) + (~!d)*sin((~!e) + (~!f)*(~x)))*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_3_28",
:(((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)* sqrt((~!d)*sin((~!e) + (~!f)*(~x))))) => :(
...
("4_1_3_29",
:(((~A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(((~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)* sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~c)^2 - (~d)^2, 0) &&
    eq((~A), (~B)) &&
    pos(((~c) + (~d))/(~b)) ?
...
("4_1_3_31",
:(((~A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(3//2)* sqrt((~c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) &&
...
("4_1_3_36",
:(((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(((~!a) + (~!b)*sin((~!e) + (~!f)*(~x)))*((~!c) + (~!d)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~x)) &&
    !eq((~b)*(~c) - (~a)*(~d), 0) &&
    !eq((~a)^2 - (~b)^2, 0) &&
    !eq((~c)^2 - (~d)^2, 0) ?
...
("4_1_3_39",
:(((~A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(sqrt(sin((~!e) + (~!f)*(~x)))* sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~A), (~B), (~x)) &&
    gt((~b), 0) &&
    gt((~b)^2 - (~a)^2, 0) &&
    eq((~A), (~B)) ?
...
("4_1_3_40",
:(((~A) + (~!B)*sin((~!e) + (~!f)*(~x)))/(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))* sqrt((~d)*sin((~!e) + (~!f)*(~x))))) => :(
...
("4_1_3_43",
:(((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))^(~!m)*((~c) + (~!d)*sin((~!e) + (~!f)*(~x)))^ (~!n)*((~!A) + (~!B)*sin((~!e) + (~!f)*(~x)))^(~p)) => :(
...
("4_1_3_44",
:(((~a) + (~!b)*cos((~!e) + (~!f)*(~x)))^(~!m)*((~c) + (~!d)*cos((~!e) + (~!f)*(~x)))^ (~!n)*((~!A) + (~!B)*cos((~!e) + (~!f)*(~x)))^(~p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~A), (~B), (~m), (~n), (~p), (~x)) &&
    eq((~b)*(~c) + (~a)*(~d), 0) &&
    eq((~a)^2 - (~b)^2, 0) ?
