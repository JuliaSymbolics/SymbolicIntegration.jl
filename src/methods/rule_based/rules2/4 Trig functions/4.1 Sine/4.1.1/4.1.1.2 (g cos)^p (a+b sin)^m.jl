...
("4_1_1_2_11",
:(sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))/sqrt((~!g)*cos((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_1_2_18",
:(sqrt((~!g)*cos((~!e) + (~!f)*(~x)))/sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~x)) &&
    eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_1_2_31",
:(1/(sqrt((~!g)*cos((~!e) + (~!f)*(~x)))*sqrt((~a) + (~!b)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_1_2_35",
:(sqrt((~!g)*cos((~!e) + (~!f)*(~x)))/((~a) + (~!b)*sin((~!e) + (~!f)*(~x)))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_1_1_2_36",
:(1/(sqrt((~!g)*cos((~!e) + (~!f)*(~x)))*((~a) + (~!b)*sin((~!e) + (~!f)*(~x))))) => :(
    !contains_var((~a), (~b), (~e), (~f), (~g), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
