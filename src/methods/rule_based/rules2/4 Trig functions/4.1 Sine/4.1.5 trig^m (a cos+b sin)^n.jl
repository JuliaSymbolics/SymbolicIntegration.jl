...
("4_1_5_9",
:(sin((~!c) + (~!d)*(~x))^ (~m)*((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~m) + (~n), 0) &&
    eq((~a)^2 + (~b)^2, 0) &&
    gt((~n), 1) ?
...
("4_1_5_10",
:(cos((~!c) + (~!d)*(~x))^ (~m)*((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))^(~n)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    eq((~m) + (~n), 0) &&
    eq((~a)^2 + (~b)^2, 0) &&
    gt((~n), 1) ?
...
("4_1_5_23",
:(((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))^(~n)/ sin((~!c) + (~!d)*(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~a)^2 + (~b)^2, 0) &&
    lt((~n), -1) ?
...
("4_1_5_24",
:(((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))^(~n)/ cos((~!c) + (~!d)*(~x))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~a)^2 + (~b)^2, 0) &&
    lt((~n), -1) ?
...
("4_1_5_30",
:(cos((~!c) + (~!d)*(~x))^ (~m)/((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~a)^2 + (~b)^2, 0) &&
    gt((~m), 1) ?
...
("4_1_5_39",
:(cos((~!c) + (~!d)*(~x))^(~!m)* sin((~!c) + (~!d)*(~x))^ (~!n)*((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))^(~!p)) => :(
...
("4_1_5_41",
:(cos((~!c) + (~!d)*(~x))^(~!m)* sin((~!c) + (~!d)*(~x))^ (~!n)/((~!a)*cos((~!c) + (~!d)*(~x)) + (~!b)*sin((~!c) + (~!d)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~x)) &&
    !eq((~a)^2 + (~b)^2, 0) &&
    igt((~m), 0) &&
    igt((~n), 0) ?
