...
("4_5_7_15",
:(sin((~!e) + (~!f)*(~x))^(~!m)*((~a) + (~!b)*((~!c)*sec((~!e) + (~!f)*(~x)))^(~n))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~e), (~f), (~n), (~p), (~x)) &&
    ext_isinteger(((~m) - 1)/2) &&
    (
        gt((~m), 0) ||
...
("4_5_7_17",
:(((~!d)*cos((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sec((~!e) + (~!f)*(~x))^(~!n))^(~!p)) => :(
...
("4_5_7_18",
:(((~!d)*cos((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*((~!c)*sec((~!e) + (~!f)*(~x)))^(~n))^ (~p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~p), (~x)) &&
    !(ext_isinteger((~m))) ?
...
("4_5_7_20",
:(tan((~!e) + (~!f)*(~x))^(~!m)*((~a) + (~!b)*((~!c)*sec((~!e) + (~!f)*(~x)))^(~n))^(~!p)) => :(
    !contains_var((~a), (~b), (~c), (~e), (~f), (~n), (~p), (~x)) &&
    ext_isinteger(((~m) - 1)/2) &&
    (
        gt((~m), 0) ||
...
("4_5_7_22",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*sec((~!e) + (~!f)*(~x))^(~n))^(~!p)) => :(
...
("4_5_7_23",
:(((~!d)*tan((~!e) + (~!f)*(~x)))^(~m)*((~!b)*((~!c)*sec((~!e) + (~!f)*(~x)))^(~n))^(~!p)) => :(
...
("4_5_7_32",
:(((~!d)*csc((~!e) + (~!f)*(~x)))^(~m)*((~a) + (~!b)*((~!c)*sec((~!e) + (~!f)*(~x)))^(~n))^ (~p)) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~f), (~m), (~n), (~p), (~x)) &&
    !(ext_isinteger((~m))) ?
