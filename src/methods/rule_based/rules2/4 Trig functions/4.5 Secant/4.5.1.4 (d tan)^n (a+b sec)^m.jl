...
("4_5_1_4_12",
:(sqrt((~!e)*cot((~!c) + (~!d)*(~x)))/((~a) + (~!b)*csc((~!c) + (~!d)*(~x)))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
...
("4_5_1_4_14",
:(1/(sqrt((~!e)*cot((~!c) + (~!d)*(~x)))*((~a) + (~!b)*csc((~!c) + (~!d)*(~x))))) => :(
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    !eq((~a)^2 - (~b)^2, 0) ?
