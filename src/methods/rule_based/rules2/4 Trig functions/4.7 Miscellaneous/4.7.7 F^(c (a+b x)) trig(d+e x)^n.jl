...
("4_7_7_12",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))*cot((~!d) + (~!e)*(~x))^(~!n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~x)) &&
    ext_isinteger((~n)) ?
(-(~I))^(~n)* ∫(ext_expand( (~F)^((~c)*((~a) + (~b)*(~x)))*(1 + ℯ^(2*(~I)*((~d) + (~e)*(~x))))^ (~n)⨸(1 - ℯ^(2*(~I)*((~d) + (~e)*(~x))))^(~n), (~x)), (~x)) : nothing))

("4_7_7_13",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))*sec((~!d) + (~!e)*(~x))^(~n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~x)) &&
    !eq((~e)^2*(~n)^2 + (~b)^2*(~c)^2*log((~F))^2, 0) &&
    lt((~n), -1) ?
...
("4_7_7_31",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))* cos((~!d) + (~!e)*(~x))^(~!m)*((~f) + (~!g)*sin((~!d) + (~!e)*(~x)))^(~!n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~f)^2 - (~g)^2, 0) &&
    ext_isinteger((~m), (~n)) &&
    eq((~m) + (~n), 0) ?
...
("4_7_7_32",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))* sin((~!d) + (~!e)*(~x))^(~!m)*((~f) + (~!g)*cos((~!d) + (~!e)*(~x)))^(~!n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~f) - (~g), 0) &&
    ext_isinteger((~m), (~n)) &&
    eq((~m) + (~n), 0) ?
...
("4_7_7_34",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~h) + (~!i)*cos((~!d) + (~!e)*(~x)))/((~f) + (~!g)*sin((~!d) + (~!e)*(~x)))) => :(
...
("4_7_7_35",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~h) + (~!i)*sin((~!d) + (~!e)*(~x)))/((~f) + (~!g)*cos((~!d) + (~!e)*(~x)))) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~x)) &&
    eq((~f)^2 - (~g)^2, 0) &&
    eq((~h)^2 - (~i)^2, 0) &&
    eq((~g)*(~h) + (~f)*(~i), 0) ?
...
("4_7_7_41",
:((~F)^((~!c)*((~!a) + (~!b)*(~x)))*sin((~!d) + (~!e)*(~x))^(~!m)* cos((~!f) + (~!g)*(~x))^(~!n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    igt((~m), 0) &&
    igt((~n), 0) ?
...
("4_7_7_42",
:((~x)^(~!p)*(~F)^((~!c)*((~!a) + (~!b)*(~x)))*sin((~!d) + (~!e)*(~x))^(~!m)* cos((~!f) + (~!g)*(~x))^(~!n)) => :(
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    igt((~m), 0) &&
    igt((~n), 0) &&
    igt((~p), 0) ?
