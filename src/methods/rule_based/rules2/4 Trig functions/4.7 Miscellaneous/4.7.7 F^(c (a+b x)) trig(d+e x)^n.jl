...
("4_7_7_25",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~f) + (~!g)*sin((~!d) + (~!e)*(~x)))^(~!n),(~x)) =>
...
("4_7_7_26",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~f) + (~!g)*cos((~!d) + (~!e)*(~x)))^(~!n),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~f) - (~g), 0) &&
    ilt((~n), 0) ?
...
("4_7_7_31",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))* cos((~!d) + (~!e)*(~x))^(~!m)*((~f) + (~!g)*sin((~!d) + (~!e)*(~x)))^(~!n),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~f)^2 - (~g)^2, 0) &&
    ext_isinteger((~m), (~n)) &&
    eq((~m) + (~n), 0) ?
...
("4_7_7_32",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))* sin((~!d) + (~!e)*(~x))^(~!m)*((~f) + (~!g)*cos((~!d) + (~!e)*(~x)))^(~!n),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    eq((~f) - (~g), 0) &&
    ext_isinteger((~m), (~n)) &&
    eq((~m) + (~n), 0) ?
...
("4_7_7_34",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~h) + (~!i)*cos((~!d) + (~!e)*(~x)))/((~f) + (~!g)*sin((~!d) + (~!e)*(~x))),(~x)) =>
...
("4_7_7_35",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))*((~h) + (~!i)*sin((~!d) + (~!e)*(~x)))/((~f) + (~!g)*cos((~!d) + (~!e)*(~x))),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~h), (~i), (~x)) &&
    eq((~f)^2 - (~g)^2, 0) &&
    eq((~h)^2 - (~i)^2, 0) &&
    eq((~g)*(~h) + (~f)*(~i), 0) ?
...
("4_7_7_39",
@rule ∫(((~!f)*(~x))^(~m)*(~F)^((~!c)*((~!a) + (~!b)*(~x)))*sin((~!d) + (~!e)*(~x)),(~x)) =>
...
("4_7_7_40",
@rule ∫(((~!f)*(~x))^(~m)*(~F)^((~!c)*((~!a) + (~!b)*(~x)))*cos((~!d) + (~!e)*(~x)),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~m), (~x)) &&
    (
        lt((~m), -1) ||
        sumsimpler((~m), 1)
...
("4_7_7_41",
@rule ∫((~F)^((~!c)*((~!a) + (~!b)*(~x)))*sin((~!d) + (~!e)*(~x))^(~!m)* cos((~!f) + (~!g)*(~x))^(~!n),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    igt((~m), 0) &&
    igt((~n), 0) ?
...
("4_7_7_42",
@rule ∫((~x)^(~!p)*(~F)^((~!c)*((~!a) + (~!b)*(~x)))*sin((~!d) + (~!e)*(~x))^(~!m)* cos((~!f) + (~!g)*(~x))^(~!n),(~x)) =>
    !contains_var((~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~x)) &&
    igt((~m), 0) &&
    igt((~n), 0) &&
    igt((~p), 0) ?
