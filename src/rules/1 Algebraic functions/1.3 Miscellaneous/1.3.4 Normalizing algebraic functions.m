...
Int[u_^p_.*v_^q_., x_Symbol] := Int[ExpandToSum[u, x]^p*ExpandToSum[v, x]^q, x] /; FreeQ[{p, q}, x] && QuadraticQ[u, x] && QuadraticQ[v, x]&& Not[QuadraticMatchQ[u, x] && QuadraticMatchQ[v, x]]
Int[z_^m_.*u_^p_.*v_^q_., x_Symbol] := Int[ExpandToSum[z, x]^m*ExpandToSum[u, x]^p*ExpandToSum[v, x]^q, x] /; FreeQ[{m, p, q}, x] && LinearQ[z, x] && QuadraticQ[u, x] && QuadraticQ[v, x]&& Not[LinearMatchQ[z, x] && QuadraticMatchQ[u, x] && QuadraticMatchQ[v, x]]
