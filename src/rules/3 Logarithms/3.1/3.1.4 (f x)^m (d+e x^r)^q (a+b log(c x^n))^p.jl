...
dist(((~a) + (~b)*log((~c)*(~x)^(~n))), ∫((~x)^(~m)*((~d) + (~e)*(~x)^(~r))^(~q), (~x))) - (~b)*(~n)*∫(simplify(∫((~x)^(~m)*((~d) + (~e)*(~x)^(~r))^(~q), (~x))⨸(~x), (~x)), (~x)) : nothing)
...
("3_1_4_11",
@rule ∫((~x)^(~!m)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p)/((~d) + (~!e)*(~x)^(~!r)),(~x)) =>
...
("3_1_4_12",
@rule ∫(((~!f)*(~x))^(~!m)*((~d) + (~!e)*(~x))^(~q)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^(~!p),(~x)) =>
...
("3_1_4_13",
@rule ∫((~x)^(~!m)*((~d) + (~!e)*(~x))^(~q)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n))),(~x)) =>
    !contains_var((~a), (~b), (~c), (~d), (~e), (~n), (~x)) &&
    ilt((~m) + (~q) + 2, 0) &&
    igt((~m), 0) ?
dist(((~a) + (~b)*log((~c)*(~x)^(~n))), ∫((~x)^(~m)*((~d) + (~e)*(~x))^(~q), (~x)), (~x)) - (~b)*(~n)*∫(simplify(∫((~x)^(~m)*((~d) + (~e)*(~x))^(~q), (~x))⨸(~x), (~x)), (~x)) : nothing)
...
("3_1_4_29",
@rule ∫(((~f) + (~!g)*(~x))^(~!m)*((~d) + (~!e)*(~x))^(~q)*((~!a) + (~!b)*log((~!c)*(~x)^(~!n)))^ (~!p),(~x)) =>
