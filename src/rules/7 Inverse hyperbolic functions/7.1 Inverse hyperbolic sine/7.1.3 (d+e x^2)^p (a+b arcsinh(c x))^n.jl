...
("7_1_3_3",
@rule ∫(((~d) + (~!e)*(~x)^2)^(~!p)*((~!a) + (~!b)*asinh((~!c)*(~x))),(~x)) =>
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~p), 0) ?
...
("7_1_3_4",
@rule ∫(sqrt((~d) + (~!e)*(~x)^2)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n),(~x)) =>
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    gt((~n), 0) ?
...
("7_1_3_6",
@rule ∫(((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)/((~d) + (~!e)*(~x)^2)^(3//2),(~x)) =>
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    gt((~n), 0) ?
...
("7_1_3_8",
@rule ∫(((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n)/((~d) + (~!e)*(~x)^2),(~x)) =>
    !contains_var((~a), (~b), (~c), (~d), (~e), (~x)) &&
    eq((~e), (~c)^2*(~d)) &&
    igt((~n), 0) ?
...
("7_1_3_14",
@rule ∫(((~d) + (~!e)*(~x))^(~p)*((~f) + (~!g)*(~x))^(~q)*((~!a) + (~!b)*asinh((~!c)*(~x)))^(~!n),(~x)) =>
