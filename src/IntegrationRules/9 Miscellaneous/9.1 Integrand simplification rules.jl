...
@smrule ∫((~!u)*((~a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~a), 0) ? ∫((~u)*((~b)*(~x)^(~n) + (~c)*(~x)^(2*(~n)))^(~p), (~x)) : nothing # 9_1_3
@smrule ∫((~!u)*((~!a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~b), 0) ? ∫((~u)*((~a) + (~c)*(~x)^(2*(~n)))^(~p), (~x)) : nothing # 9_1_4
@smrule ∫((~!u)*((~!a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~c), 0) ? ∫((~u)*((~a) + (~b)*(~x)^(~n))^(~p), (~x)) : nothing # 9_1_5
