...
("9_1_1",
@smrule ∫((~!u)*((~a) + (~!b)*(~x)^(~!n))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~n), (~p)) && eqQ((~a), 0) ? ∫((~u)*((~b)*(~x)^(~n))^(~p), (~x)) : nothing)
("9_1_2",
@smrule ∫((~!u)*((~!a) + (~!b)*(~x)^(~!n))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~n), (~p)) && eqQ((~b), 0) ? ∫((~u)*(~a)^(~p), (~x)) : nothing)
("9_1_3",
@smrule ∫((~!u)*((~a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~a), 0) ? ∫((~u)*((~b)*(~x)^(~n) + (~c)*(~x)^(2*(~n)))^(~p), (~x)) : nothing)
("9_1_4",
@smrule ∫((~!u)*((~!a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~b), 0) ? ∫((~u)*((~a) + (~c)*(~x)^(2*(~n)))^(~p), (~x)) : nothing)
("9_1_5",
@smrule ∫((~!u)*((~!a) + (~!b)*(~x)^(~!n) + (~!c)*(~x)^(~!j))^(~!p),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~n), (~p)) && eqQ((~j), 2*(~n)) && eqQ((~c), 0) ? ∫((~u)*((~a) + (~b)*(~x)^(~n))^(~p), (~x)) : nothing)
("9_1_6",
@smrule ∫((~!u)*((~!a)*(~v) + (~!b)*(~v) + (~!w))^(~!p),(~x)) => !contains_var((~x), (~a), (~b)) && !(!contains_var((~x), (~v))) ? ∫((~u)*(((~a) + (~b))*(~v) + (~w))^(~p), (~x)) : nothing)
# ("9_1_7",
# @smrule ∫((~!u)*P(~x)^(~p),(~x)) => PolyQ[Px, (~x)] && !(RationalQ[(~p))] && !contains_var((~x), (~p)) && RationalQ[Simplify[(~p)]] ? ∫((~u)*Px^Simplify[(~p)), (~x)) : nothing)
("9_1_8",
@smrule ∫((~a),(~x)) => !contains_var((~x), (~a)) ? (~a)*(~x) : nothing)
("9_1_9",
@smrule ∫((~a)*((~b) + (~!c)*(~x)),(~x)) => !contains_var((~x), (~a), (~b), (~c)) ? (~a)*((~b) + (~c)*(~x))^2⨸(2*(~c)) : nothing)
# ("9_1_10",
...
("9_1_15",
@smrule ∫((~!u)*(~v)^(~!m)*((~b)*(~v))^(~n),(~x)) => !contains_var((~x), (~b), (~n)) && isa((~m), Integer) ? 1⨸(~b)^(~m)*∫((~u)*((~b)*(~v))^((~m) + (~n)), (~x)) : nothing)
("9_1_16",
@smrule ∫((~!u)*((~!a)*(~v))^(~m)*((~!b)*(~v))^(~n),(~x)) => !contains_var((~x), (~a), (~b), (~m)) && !(isa((~m), Integer)) && igtQ((~n) + 1/2, 0) && isa((~m) + (~n), Integer) ? (~a)^((~m) + 1⨸2)*(~b)^((~n) - 1⨸2)*sqrt((~b)*(~v))⨸sqrt((~a)*(~v))*∫((~u)*(~v)^((~m) + (~n)), (~x)) : nothing)
...
("9_1_17",
@smrule ∫((~!u)*((~!a)*(~v))^(~m)*((~!b)*(~v))^(~n),(~x)) => !contains_var((~x), (~a), (~b), (~m)) && !(isa((~m), Integer)) && iltQ((~n) - 1/2, 0) && isa((~m) + (~n), Integer) ? (~a)^((~m) - 1⨸2)*(~b)^((~n) + 1⨸2)*sqrt((~a)*(~v))⨸sqrt((~b)*(~v))*∫((~u)*(~v)^((~m) + (~n)), (~x)) : nothing)
...
("9_1_18",
@smrule ∫((~!u)*((~!a)*(~v))^(~m)*((~!b)*(~v))^(~n),(~x)) => !contains_var((~x), (~a), (~b), (~m), (~n)) && !(isa((~m), Integer)) && !(isa((~n), Integer)) && isa((~m) + (~n), Integer) ? (~a)^((~m) + (~n))*((~b)*(~v))^(~n)⨸((~a)*(~v))^(~n)*∫((~u)*(~v)^((~m) + (~n)), (~x)) : nothing)
("9_1_19",
...
("9_1_22",
@smrule ∫((~!u)*((~a) + (~!b)*(~v))^(~m)*((~c) + (~!d)*(~v))^(~n),(~x)) => !contains_var((~x), (~a), (~b), (~c), (~d), (~m), (~n)) && eqQ((~b)*(~c) - (~a)*(~d), 0) && !(isa((~m), Integer) || isa((~n), Integer) || ((~b)/(~d) > 0)) ? ((~a) + (~b)*(~v))^(~m)⨸((~c) + (~d)*(~v))^(~m)*∫((~u)*((~c) + (~d)*(~v))^((~m) + (~n)), (~x)) : nothing)
