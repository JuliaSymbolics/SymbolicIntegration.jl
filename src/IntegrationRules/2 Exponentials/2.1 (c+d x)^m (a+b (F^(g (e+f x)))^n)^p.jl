...
("2_1_8",
@rule ∫(((~!c) + (~!d)*(~x))^(~!m)*((~a) + (~!b)*((~F)^((~!g)*((~!e) + (~!f)*(~x))))^(~!n))^(~!p),(~x)) => !contains_var((~x), (~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~m), (~n)) && igt((~p), 0) ? ∫(expand(((~c) + (~d)*(~x))^(~m)), (~x)) : nothing)
("2_1_9",
@rule ∫(((~!c) + (~!d)*(~x))^(~!m)/((~a) + (~!b)*((~F)^((~!g)*((~!e) + (~!f)*(~x))))^(~!n)),(~x)) => !contains_var((~x), (~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~n)) && igt((~m), 0) ? ((~c) + (~d)*(~x))^((~m) + 1)⨸((~a)*(~d)*((~m) + 1)) - (~b)⨸(~a)*∫(((~c) + (~d)*(~x))^ (~m)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n)⨸((~a) + (~b)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n)), (~x)) : nothing)
...
("2_1_10",
@rule ∫(((~!c) + (~!d)*(~x))^(~!m)*((~a) + (~!b)*((~F)^((~!g)*((~!e) + (~!f)*(~x))))^(~!n))^(~p),(~x)) => !contains_var((~x), (~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~n)) && ilt((~p), 0) && igt((~m), 0) ? 1⨸(~a)*∫(((~c) + (~d)*(~x))^(~m)*((~a) + (~b)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n))^((~p) + 1), (~x)) - (~b)⨸(~a)* ∫(((~c) + (~d)*(~x))^(~m)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n)*((~a) + (~b)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n))^(~p), (~x)) : nothing)
# ("2_1_11",
# @rule ∫(((~!c) + (~!d)*(~x))^(~!m)*((~a) + (~!b)*((~F)^((~!g)*((~!e) + (~!f)*(~x))))^(~!n))^(~p),(~x)) => !contains_var((~x), (~F), (~a), (~b), (~c), (~d), (~e), (~f), (~g), (~n)) && igt((~m), 0) && ((~p) < -1) ? With[{(~u) = IntHide[((~a) + (~b)*((~F)^((~g)*((~e) + (~f)*(~x))))^(~n))^(~p), (~x))}, Dist[((~c) + (~d)*(~x))^(~m), (~u), (~x)) - (~d)*(~m)*∫(((~c) + (~d)*(~x))^((~m) - 1)*(~u), (~x))) : nothing)
# ("2_1_12",
