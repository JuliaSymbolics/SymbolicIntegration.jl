...
(sin(x)/sqrt(1 + x), sqrt(2*π)*cos(1)*FresnelS(sqrt(2/π)*sqrt(1 + x)) - sqrt(2*π)*FresnelC(sqrt(2/π)*sqrt(1 + x))*sin(1), x, 5),
...
(log(1 + exp(x))/(1 + exp(2*x)), (-(1//2))*log((1//2 - I/2)*(I - ℯ^x))*log(1 + ℯ^x) - (1//2)*log((-(1//2) - I/2)*(I + ℯ^x))*log(1 + ℯ^x) - PolyLog(2, -ℯ^x) - (1//2)*PolyLog(2, (1//2 - I/2)*(1 + ℯ^x)) - (1//2)*PolyLog(2, (1//2 + I/2)*(1 + ℯ^x)), x, 12),
(log(1 + cosh(x)^2)^2*cosh(x), -8*sqrt(2)*atan(sinh(x)/sqrt(2)) + 4*I*sqrt(2)*atan(sinh(x)/sqrt(2))^2 + 8*sqrt(2)*atan(sinh(x)/sqrt(2))*log((2*sqrt(2))/(sqrt(2) + I*sinh(x))) + 4*sqrt(2)*atan(sinh(x)/sqrt(2))*log(2 + sinh(x)^2) + 4*I*sqrt(2)*PolyLog(2, 1 - (2*sqrt(2))/(sqrt(2) + I*sinh(x))) + 8*sinh(x) - 4*log(2 + sinh(x)^2)*sinh(x) + log(2 + sinh(x)^2)^2*sinh(x), x, 13),
...
(log(x + sqrt(1 + x))/x, log(-1 + sqrt(1 + x))*log(x + sqrt(1 + x)) + log(1 + sqrt(1 + x))*log(x + sqrt(1 + x)) - log(-1 + sqrt(1 + x))*log((1 - sqrt(5) + 2*sqrt(1 + x))/(3 - sqrt(5))) - log(1 + sqrt(1 + x))*log(-((1 - sqrt(5) + 2*sqrt(1 + x))/(1 + sqrt(5)))) - log(1 + sqrt(1 + x))*log(-((1 + sqrt(5) + 2*sqrt(1 + x))/(1 - sqrt(5)))) - log(-1 + sqrt(1 + x))*log((1 + sqrt(5) + 2*sqrt(1 + x))/(3 + sqrt(5))) - PolyLog(2, (2*(1 - sqrt(1 + x)))/(3 - sqrt(5))) - PolyLog(2, (2*(1 - sqrt(1 + x)))/(3 + sqrt(5))) - PolyLog(2, (2*(1 + sqrt(1 + x)))/(1 - sqrt(5))) - PolyLog(2, (2*(1 + sqrt(1 + x)))/(1 + sqrt(5))), x, 21),


(atan(2*tan(x)), x*atan(2*tan(x)) + (1//2)*I*x*log(1 - 3*ℯ^(2*I*x)) - (1//2)*I*x*log(1 - (1//3)*ℯ^(2*I*x)) - (1//4)*PolyLog(2, (1//3)*ℯ^(2*I*x)) + (1//4)*PolyLog(2, 3*ℯ^(2*I*x)), x, 7),
(atan(x)*log(x)/x, (1//2)*I*log(x)*PolyLog(2, (-I)*x) - (1//2)*I*log(x)*PolyLog(2, I*x) - (1//2)*I*PolyLog(3, (-I)*x) + (1//2)*I*PolyLog(3, I*x), x, 5),


# Note: Mathematica is unable to differentiate result back to integrand! 
(atan(x)^2*sqrt(1 + x^2), asinh(x) - sqrt(1 + x^2)*atan(x) + (1//2)*x*sqrt(1 + x^2)*atan(x)^2 - I*atan(ℯ^(I*atan(x)))*atan(x)^2 + I*atan(x)*PolyLog(2, (-I)*ℯ^(I*atan(x))) - I*atan(x)*PolyLog(2, I*ℯ^(I*atan(x))) - PolyLog(3, (-I)*ℯ^(I*atan(x))) + PolyLog(3, I*ℯ^(I*atan(x))), x, 10),
]
