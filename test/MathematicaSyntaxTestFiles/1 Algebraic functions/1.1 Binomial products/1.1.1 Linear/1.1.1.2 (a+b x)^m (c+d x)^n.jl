...
# 
# 
#     (integrand = x^(-4 + n)/(a + b*x)^n, result = If($VersionNumber>=8, -((x^(-3 + n)*(a + b*x)^(1 - n))/(a*(3 - n))) + (2*b*x^(-2 + n)*(a + b*x)^(1 - n))/(a^2*(2 - n)*(3 - n)) - (2*b^2*x^(-1 + n)*(a + b*x)^(1 - n))/(a^3*(1 - n)*(2 - n)*(3 - n)), -((x^(-3 + n)*(a + b*x)^(1 - n))/(a*(3 - n))) + (2*b*x^(-2 + n)*(a + b*x)^(1 - n))/(a^2*(2 - n)*(3 - n)) - (2*b^2*x^(-1 + n)*(a + b*x)^(1 - n))/(a^3*(3 - n)*(2 - 3*n + n^2))), integration_var = x, mistery_val = 3),
...
# 
#     (integrand = x^(-3 - n)*(a + b*x)^n, result = -((x^(-2 - n)*(a + b*x)^(1 + n))/(a*(2 + n))) + (b*x^(-1 - n)*(a + b*x)^(1 + n))/(a^2*(1 + n)*(2 + n)), integration_var = x, mistery_val = 2),
#     (integrand = x^(2*n - 3*(1 + n))*(a + b*x)^n, result = If($VersionNumber>=8, -((x^(-2 - n)*(a + b*x)^(1 + n))/(a*(2 + n))) + (b*x^(-1 - n)*(a + b*x)^(1 + n))/(a^2*(1 + n)*(2 + n)), -((x^(-2 - n)*(a + b*x)^(1 + n))/(a*(2 + n))) + (b*x^(-1 - n)*(a + b*x)^(1 + n))/(a^2*(2 + 3*n + n^2))), integration_var = x, mistery_val = 2),
# 
# 
# # ::Title::Closed::
...
# 
# 
#     (integrand = 1/((6 - 3*e*x)^(1/4)*(2 + e*x)^(3/4)), result = If($VersionNumber>=8, (sqrt(2)*atan(1 - (sqrt(2)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4)))/(3^(1/4)*e) - (sqrt(2)*atan(1 + (sqrt(2)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4)))/(3^(1/4)*e) - log((sqrt(6 - 3*e*x) - sqrt(6)*(2 - e*x)^(1/4)*(2 + e*x)^(1/4) + sqrt(3)*sqrt(2 + e*x))/sqrt(2 + e*x))/(sqrt(2)*3^(1/4)*e) + log((sqrt(6 - 3*e*x) + sqrt(6)*(2 - e*x)^(1/4)*(2 + e*x)^(1/4) + sqrt(3)*sqrt(2 + e*x))/sqrt(2 + e*x))/(sqrt(2)*3^(1/4)*e), (sqrt(2)*atan(1 - (sqrt(2)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4)))/(3^(1/4)*e) - (sqrt(2)*atan(1 + (sqrt(2)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4)))/(3^(1/4)*e) - log(sqrt(3) + (sqrt(3)*sqrt(2 - e*x))/sqrt(2 + e*x) - (sqrt(6)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4))/(sqrt(2)*3^(1/4)*e) + log(sqrt(3) + (sqrt(3)*sqrt(2 - e*x))/sqrt(2 + e*x) + (sqrt(6)*(2 - e*x)^(1/4))/(2 + e*x)^(1/4))/(sqrt(2)*3^(1/4)*e)), integration_var = x, mistery_val = 11),
# 
# 
# # ::Subsubsection::
# # n>0
...
# 
# 
#     (integrand = (a + b*x)^m/(a*c*(m + 1) + b*c*(m + 2)*x)^(m + 3), result = If($VersionNumber>=8, -(((a + b*x)^(1 + m)*(a*c*(1 + m) + b*c*(2 + m)*x)^(-2 - m))/(a*b*c*(2 + m))) + ((a + b*x)^(1 + m)*(a*c*(1 + m) + b*c*(2 + m)*x)^(-1 - m))/(a^2*b*c^2*(1 + m)*(2 + m)), -(((a + b*x)^(1 + m)*(a*c*(1 + m) + b*c*(2 + m)*x)^(-2 - m))/(a*b*c*(2 + m))) + ((a + b*x)^(1 + m)*(a*c*(1 + m) + b*c*(2 + m)*x)^(-1 - m))/(a^2*b*c^2*(2 + 3*m + m^2))), integration_var = x, mistery_val = 2),
